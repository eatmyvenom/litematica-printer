...
public class LitematicaMixinMod implements ModInitializer {
    ...
    public static final ConfigString  EASY_PLACE_MODE_REPLACE_FLUIDS= new ConfigString("easyPlaceModeReplaceFluids", "none", "To enable, type the name of the block which should be placed instead of a fluid source.");
